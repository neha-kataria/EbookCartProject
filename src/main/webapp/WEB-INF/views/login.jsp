...
<html >
    ...
    <body>
        <!--<div style="color: white">${param.buy}</div>-->
        <div class="loginpanel">
            ...
            <script>
                ...
                <form action="submitLogin" method="POST" name="submitForm" >
                    <input type="hidden" name="buy" value="${param.buy}" id="buy">
                    <div class="txt">
                    ...
                    <div class="buttons">
                        ...
                        <span>
                            <a href="/EbookCart/register?buy=${param.buy}" class="entypo-user-add register">Register</a>
                        </span>
                    </div>
                </form>
                <div class="hr">
           ...
           //        'Thanks for logging in, ' + response.name + '!';
                            ...
                            var url="/EbookCart/fbSuccess?buy="+buy+"&login_type=fb&login_name="+response.name;
                ...
                <div class="social">
                    ...
                    <input type="hidden" id="login_name" name="login_name" value="nk">

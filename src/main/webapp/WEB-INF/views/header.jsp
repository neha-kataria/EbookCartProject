...
<html>
    ...
    <body>
        <div id="header" class="shell">
            ...
            <div id="site_logo" ><h1><a href="/EbookCart/home">ebookCart</a></h1></div>
            <% //String user=(String)request.getAttribute("logged_user");
            String name= (String)session.getAttribute("logged_user");
            //String name=user;
          ...
          //  System.out.println("inside scriplet"+name+"    "+type);
            ...
            <div id="navigation">
                <ul>
                    <li><a href="/EbookCart/home" class="active">Home</a></li>

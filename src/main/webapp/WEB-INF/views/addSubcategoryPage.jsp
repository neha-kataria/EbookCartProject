<%-- 
    Document   : addSubcategoryPage
    Created on : 8 Nov, 2016, 1:03:01 PM
    Author     : neha
--%>
                                            ...
                                            <form id="subcategory-form" name="subCategoryForm" action="submitSubCategoryForm" method="POST" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="subcategory-name" name="subcategoryName" required="required" class="form-control col-md-7 col-xs-12">
                                                    </div>
                                                </div>
                                                <div class="form-group">

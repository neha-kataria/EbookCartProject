                                        ...
                                        <table class="table table-striped jambo_table bulk_action">
                                            ...
                                            <c:forEach items="${catg_list}" var="catg">
                                                <tr>
                                                    ...
                                                    <td><c:out value="${catg.subCatg_parentName}" /></td>
                                                   <!-- <td><c:out value="${catg.subCatg_path}" /></td> -->
                                                    <td><!--<c:out value="assets/subcategory/${catg.subCatg_thumb_name}" />-->
                                                        <img src="<c:out value="assets/subcategory/${catg.subCatg_thumb_name}" />" height="100" width="100" ></td>
                                                    <td >
